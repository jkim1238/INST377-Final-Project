...
<body>
    ...
    <div class="container-fluid container-xxl bg-light">
        ...
        <?php
            // This page deletes a genre.
            // This page is accessed through view_genres.php.

            // Check for a valid genre ID, through GET or POST.
            ...
            if (isset($_POST['id'])) {
                if ($_POST['sure'] == 'Yes') { // Delete the record.
                    ...
                    if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
                        ...
                        echo '
                            <div class="alert alert-warning">
                                <strong>System Error!</strong> The genre could not be deleted due to a system error.
                            </div>
                            <div class="alert alert-info">
                ...
                } else { // Wasn't sure about deleting the mood.
                    echo '
                        <div class="alert alert-warning">
                ...
                if (mysqli_num_rows($result) == 1) { // Valid mood ID, show the form.
                    ...
                    echo '
                        ...
                        <form action="delete_genres.php" method="post">
