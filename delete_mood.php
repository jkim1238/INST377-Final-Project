...
<body>
    ...
    <div class="container-fluid container-xxl bg-light">
        ...
        <?php
            // This page deletes a mood.
            // This page is accessed through view_mood.php.
            ...
            if (isset($_POST['id'])) {
                if ($_POST['sure'] == 'Yes') { // Delete the record.
                    ...
                    if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
                        ...
                        echo '
                            <div class="alert alert-warning">
                                <strong>System Error!</strong> The mood could not be deleted due to a system error.
                            </div>
                            <div class="alert alert-info">
                ...
                if (mysqli_num_rows($result) == 1) { // Valid mood ID, show the form.
                    ...
                    echo '
                        ...
                        <form action="delete_mood.php" method="post">
