...
<body>
    ...
    <div class="container-fluid container-xxl bg-light">
                ...
                if ($result) { // If the query ran OK.
                    ...
                    echo "
                        <div class='alert alert-success'>
                            <strong>Success!</strong> You have added to the genre table.
                        </div>
                    ";
                    ...
                    echo "
                        <div class='alert alert-warning'>
                            <strong>System Error!</strong> The genre could not be added due to a system error. We apologize for any inconvenience.
                        </div>
                        <div class='alert alert-info'>
        ...
        <form action="add_genres.php" method="post" class="was-validated">
            <div class="mb-3 mt-3">
